...
class BundleHabitTile extends ConsumerWidget {
  ...
  const BundleHabitTile({super.key, required this.habit, required this.allHabits});
    ...
    return Container(
      ...
      child: ClipRRect(
        ...
        child: InkWell(
          ...
          child: Column(
            children: [
              _buildBundleHeader(context, ref, progress, isCompleted, progressPercentage, children),
              AnimatedCrossFade(
